...
module.exports = function html(names, prefix, data) {
    var width = data.frames[0].width;
var  str = `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="text-align: center;">
    ...
    <div style="position: fixed; bottom: 60px;">
        Change the width：
        <input type="range" min="${width - 50 > 0? width - 50: 0}" max="${width + 50}" value="${width}" class="range" id="range">
    </div>
    <div style="position: fixed; bottom: 10px;">
        Powered By <a target="_blank" href="https://github.com/gkajs/gka">gka</a> .
        Template By <a target="_blank" href="https://github.com/gkajs/gka-tpl-percent">gka-tpl-percent</a>
    </div>
    <script>
